...
window.scwEvents = window.scwEvents || {},
    function(e) {
        ...
        SEMICOLON.initialize = {
            ...
            availableFunc: (i, n) => {
                if (i.length < 1) return !1;
                let t = new IntersectionObserver((i, t) => {
                    i.forEach(i => {
                        SEMICOLON.initialize.jsLinking(e(i.target), n), t.unobserve(i.target)
                    })
                }, {
            ...
            functions: function(i) {
                let n, t, s;
                "object" == typeof i.element && null !== i.element && ("undefined" !== i.element.parent && (t = i.element.parent), "undefined" !== i.element.el && (i.element = i.element.el)), s = i.element ? i.element : i.default, n = "object" === t ? t.find(s) : e(s), this.availableFunc(n, i)
            },
            defaults: function() {
                if (jRespond([{
                        label: "smallest",
